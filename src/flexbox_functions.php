...
namespace curiositry\flexbox_functions;
...
function justify_content_start() {
  	return <<<FLEX
...
function justify_content_center() {
  	echo <<<FLEX
...
function justify_content_space_between() {
  	return <<<FLEX
...
function justify_content_space_around() {
  	return <<<FLEX
...
function flex_direction_row_reverse() {
  	return <<<FLEX
...
function flex_direction_column() {
  	return <<<FLEX
	box-direction: normal;
	box-orient: vertical;
...
function flex_direction_column_reverse() {
  	return <<<FLEX
	box-direction: reverse;
	box-orient: vertical;
	-webkit-box-orient: vertical;
...
function flex_wrap_wrap_reverse() {
  	return <<<FLEX
